const firebaseConfig = {
  ...
  //////////////////Cap nhat nhiet do/////////////////////////////
firebase.database().ref("/Phong Khach/Temp").on("value", function(snapshot){
  ...
  /////////////////Cap nhat do am////////////////////////////////
firebase.database().ref("/Phong Khach/Humi").on("value", function(snapshot){
  ...
  /////////////////Cap nhat gas////////////////////////////////
firebase.database().ref("/Phong Khach/Gas").on("value", function(snapshot){
  ...
  /////////////////Cap nhat anh sang////////////////////////////////
firebase.database().ref("/Phong Khach/LightSensor").on("value", function(snapshot){
...
$(document).ready(function(){
  ...
  var bed;
  var fan;
  database.ref("/Phong Khach").on("value", function(snap){
  bath = snap.val().bath;
  ...
  var firebaseRef = firebase.database().ref().child("/Phong Khach/bath");
  if(bath == "1"){
  firebaseRef.set("0");
  bath = "0";
  } else {
  ...
  var firebaseRef = firebase.database().ref().child("/Phong Khach/phone");
  if(phone == "1"){
  firebaseRef.set("0");
  phone = "0";
  } else {
  ...
  var firebaseRef = firebase.database().ref().child("/Phong Khach/tv");
  if(tv == "1"){
  firebaseRef.set("0");
  tv = "0";
  } else {
  ...
  var firebaseRef = firebase.database().ref().child("/Phong Khach/bed");
  if(bed == "1"){
  firebaseRef.set("0");
  bed = "0";
  } else {
  ...
  $(".toggle-btn4").click(function(){
    var firebaseRef = firebase.database().ref().child("/Phong Khach/fan");
    if(fan == "1"){
    firebaseRef.set("0");
    fan = "0";
    } else {
